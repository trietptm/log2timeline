...
Parse::Evtx::Chunk - parses a chunk of a Microsoft Windows Vista event log 
file (.evtx)
...
L<Parse::Evtx::Event> object on success and C<undef> on failure. Note that 
...
evtxdump.pl, evtxtemplates.pl, Parse::Evtx, Parse::Evtx::Event
